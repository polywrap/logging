/** Constants used by the default infrastructure module. */
export declare const ETH_ENS_IPFS_MODULE_CONSTANTS: {
    readonly ipfsProvider: "http://localhost:5001";
    readonly ethereumProvider: "http://localhost:8545";
    readonly ensAddresses: {
