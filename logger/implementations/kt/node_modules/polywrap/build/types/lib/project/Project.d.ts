...
export declare abstract class Project<TManifest extends AnyProjectManifest> {
    ...
    abstract getGenerationDirectory(generationSubPath?: string): Promise<string>;
    abstract generateSchemaBindings(abi: Abi, generationSubPath?: string, bindgenUri?: string, bindConfig?: Record<string, unknown>): Promise<BindOutput>;
    get logger(): Logger;
}
