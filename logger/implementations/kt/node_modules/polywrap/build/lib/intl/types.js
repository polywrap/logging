...
exports.intlMsg = {
    ...
    commands_common_options_wrapperEnvsPath: function () { return intl.formatMessage({ id: "commands_common_options_wrapperEnvsPath", defaultMessage: "envs-path" }); },
    ...
    commands_common_options_wrapperEnvs: function () { return intl.formatMessage({ id: "commands_common_options_wrapperEnvs", defaultMessage: "Path to a JSON file containing wrapper envs" }); },
    ...
    commands_common_options_w: function () { return intl.formatMessage({ id: "commands_common_options_w", defaultMessage: "Automatically execute command when changes are made (default: false)" }); },
    ...
    commands_build_error_goModNotFound: function (options) { return intl.formatMessage({ id: "commands_build_error_goModNotFound", defaultMessage: "go.mod file not found. Search paths used: {paths}" }, options); },
    ...
    commands_build_error_unsupportedProjectType: function (options) { return intl.formatMessage({ id: "commands_build_error_unsupportedProjectType", defaultMessage: "Unsupported project type. You can only build the following project types: {supportedTypes}" }, options); },
    ...
    commands_build_options_m: function (options) { return intl.formatMessage({ id: "commands_build_options_m", defaultMessage: "Path to the Polywrap manifest file (default: {default})" }, options); },
    ...
    commands_build_options_codegen: function () { return intl.formatMessage({ id: "commands_build_options_codegen", defaultMessage: "Skip code generation before build" }); },
    commands_build_options_codegen_dir: function (options) { return intl.formatMessage({ id: "commands_build_options_codegen_dir", defaultMessage: "Codegen output directory (default: {default})" }, options); },
    commands_build_options_s: function (options) { return intl.formatMessage({ id: "commands_build_options_s", defaultMessage: "Strategy to use for building the wrapper (default: {default})" }, options); },
    ...
    commands_build_options_l: function () { return intl.formatMessage({ id: "commands_build_options_l", defaultMessage: "Log file to save console output to" }); },
    commands_build_error_codegen_failed: function () { return intl.formatMessage({ id: "commands_build_error_codegen_failed", defaultMessage: "Code generation failed" }); },
    ...
    commands_deploy_error_primaryJobNotFound: function () { return intl.formatMessage({ id: "commands_deploy_error_primaryJobNotFound", defaultMessage: "A primary job was indicated but not found in the manifest" }); },
    commands_deploy_deployment_written: function (options) { return intl.formatMessage({ id: "commands_deploy_deployment_written", defaultMessage: "The URI result from job {primaryJobName} has been written to {deploymentFilepath}. It is recommended to store this file at the root of your wrap package and commit it to your repository." }, options); },
    ...
    commands_codegen_options_b: function () { return intl.formatMessage({ id: "commands_codegen_options_b", defaultMessage: "Uri for custom bindgen wrap (must implement wrap-abi-bindgen interface; see https://github.com/polywrap/wrap-abi-bindgen)" }); },
    ...
    commands_codegen_invalid_uri: function (options) { return intl.formatMessage({ id: "commands_codegen_invalid_uri", defaultMessage: "Invalid WRAP URI format: {uri}." }, options); },
    commands_codegen_project_load_error: function (options) { return intl.formatMessage({ id: "commands_codegen_project_load_error", defaultMessage: "Failed to load project, please make sure {manifestPath} is a valid Project manifest" }, options); },
    ...
    commands_create_error_badUrl: function (options) { return intl.formatMessage({ id: "commands_create_error_badUrl", defaultMessage: "URL {url} uses an invalid format. Valid URL formats: {formats}" }, options); },
    ...
    commands_create_options_t: function () { return intl.formatMessage({ id: "commands_create_options_t", defaultMessage: "Download template from a URL." }); },
    commands_create_options_t_url: function () { return intl.formatMessage({ id: "commands_create_options_t_url", defaultMessage: "URL" }); },
    commands_create_options_formats: function () { return intl.formatMessage({ id: "commands_create_options_formats", defaultMessage: "formats" }); },
    ...
    commands_create_ready: function () { return intl.formatMessage({ id: "commands_create_ready", defaultMessage: "You are ready to build with Polywrap" }); },
    ...
    commands_test_options_workflow: function () { return intl.formatMessage({ id: "commands_test_options_workflow", defaultMessage: "workflow" }); },
    commands_test_options_workflowScript: function () { return intl.formatMessage({ id: "commands_test_options_workflowScript", defaultMessage: "Path to workflow script" }); },
    commands_test_options_outputFilePath: function () { return intl.formatMessage({ id: "commands_test_options_outputFilePath", defaultMessage: "output-file-path" }); },
    commands_test_options_validateScript: function () { return intl.formatMessage({ id: "commands_test_options_validateScript", defaultMessage: "Validate the output of the workflow jobs" }); },
    commands_test_options_validate: function () { return intl.formatMessage({ id: "commands_test_options_validate", defaultMessage: "cue-file" }); },
    commands_test_options_outputFile: function () { return intl.formatMessage({ id: "commands_test_options_outputFile", defaultMessage: "Output file path for the test result" }); },
    commands_test_options_m_path: function () { return intl.formatMessage({ id: "commands_test_options_m_path", defaultMessage: "path" }); },
    commands_test_options_m: function (options) { return intl.formatMessage({ id: "commands_test_options_m", defaultMessage: "Path to the Polywrap Test manifest file (default: {default})" }, options); },
    commands_test_options_jobIds: function () { return intl.formatMessage({ id: "commands_test_options_jobIds", defaultMessage: "jobs" }); },
    commands_test_options_jobs: function () { return intl.formatMessage({ id: "commands_test_options_jobs", defaultMessage: "Specify ids of jobs that you want to run" }); },
    commands_test_error_validatorNotFound: function (options) { return intl.formatMessage({ id: "commands_test_error_validatorNotFound", defaultMessage: "validate script not found at: {path}" }, options); },
    commands_test_error_outputFileMissing: function (options) { return intl.formatMessage({ id: "commands_test_error_outputFileMissing", defaultMessage: "{option} option missing {argument} argument" }, options); },
    commands_test_error_clientConfigMissingPath: function (options) { return intl.formatMessage({ id: "commands_test_error_clientConfigMissingPath", defaultMessage: "{option} option missing {argument} argument" }, options); },
    commands_test_error_clientConfigModuleMissingExport: function (options) { return intl.formatMessage({ id: "commands_test_error_clientConfigModuleMissingExport", defaultMessage: "Custom client config module missing named export 'configure' at {module}" }, options); },
    commands_test_error_clientConfigInvalidFileExt: function (options) { return intl.formatMessage({ id: "commands_test_error_clientConfigInvalidFileExt", defaultMessage: "Custom client config file: {module} must be a JS/TS file" }, options); },
    commands_test_error_clientConfigNotObject: function () { return intl.formatMessage({ id: "commands_test_error_clientConfigNotObject", defaultMessage: "Custom client config must be an object" }); },
    commands_test_error_redirectsExportNotArray: function () { return intl.formatMessage({ id: "commands_test_error_redirectsExportNotArray", defaultMessage: "Exported redirects must be an array" }); },
    commands_test_error_redirectsItemNotValid: function (options) { return intl.formatMessage({ id: "commands_test_error_redirectsItemNotValid", defaultMessage: "Redirect at index {index} must be an object with properties 'from' and 'to'" }, options); },
    commands_test_error_redirectsItemFromNotString: function (options) { return intl.formatMessage({ id: "commands_test_error_redirectsItemFromNotString", defaultMessage: "Redirect property 'from' at index {index} must be a valid wrap:// URI string" }, options); },
    commands_test_error_redirectsItemToNotStringOrObject: function (options) { return intl.formatMessage({ id: "commands_test_error_redirectsItemToNotStringOrObject", defaultMessage: "Redirect property 'to' at index {index} must be a valid wrap:// URI string, or a plugin" }, options); },
    commands_test_error_redirectsItemToNotValidPlugin: function (options) { return intl.formatMessage({ id: "commands_test_error_redirectsItemToNotValidPlugin", defaultMessage: "Redirect property 'to' at index {index} must be a valid plugin instance" }, options); },
    commands_test_error_pluginsExportNotArray: function () { return intl.formatMessage({ id: "commands_test_error_pluginsExportNotArray", defaultMessage: "Exported plugins must be an array" }); },
    commands_test_error_pluginsItemNotObject: function (options) { return intl.formatMessage({ id: "commands_test_error_pluginsItemNotObject", defaultMessage: "Plugin at index {index} must be an object with properties 'uri' and 'plugin'" }, options); },
    commands_test_error_pluginsItemUriNotString: function (options) { return intl.formatMessage({ id: "commands_test_error_pluginsItemUriNotString", defaultMessage: "Plugin property 'uri' at index {index} must be a valid wrap:// URI string" }, options); },
    commands_test_error_pluginsItemPluginNotObject: function (options) { return intl.formatMessage({ id: "commands_test_error_pluginsItemPluginNotObject", defaultMessage: "Plugin property 'plugin' at index {index} must be an object with properties 'factory' and 'manifest'" }, options); },
    commands_test_error_pluginsItemPluginFactoryNotFunction: function (options) { return intl.formatMessage({ id: "commands_test_error_pluginsItemPluginFactoryNotFunction", defaultMessage: "Plugin property 'plugin.factory' at index {index} must be a function" }, options); },
    commands_test_error_pluginsItemPluginManifestNotObject: function (options) { return intl.formatMessage({ id: "commands_test_error_pluginsItemPluginManifestNotObject", defaultMessage: "Plugin property 'plugin.manifest' at index {index} must be an object" }, options); },
    commands_test_error_interfacesExportNotArray: function () { return intl.formatMessage({ id: "commands_test_error_interfacesExportNotArray", defaultMessage: "Exported interfaces must be an array" }); },
    commands_test_error_interfacesItemNotObject: function (options) { return intl.formatMessage({ id: "commands_test_error_interfacesItemNotObject", defaultMessage: "Interface at index {index} must be an object with properties 'interface' and 'implementations'" }, options); },
    commands_test_error_interfacesItemInterfaceNotString: function (options) { return intl.formatMessage({ id: "commands_test_error_interfacesItemInterfaceNotString", defaultMessage: "Interface property 'interface' at index {index} must be a valid wrap:// URI string" }, options); },
    commands_test_error_interfacesItemImplementationsNotArray: function (options) { return intl.formatMessage({ id: "commands_test_error_interfacesItemImplementationsNotArray", defaultMessage: "Interface property 'implementations' at index {index} must be an array" }, options); },
    commands_test_error_interfacesItemImplementationsEmpty: function (options) { return intl.formatMessage({ id: "commands_test_error_interfacesItemImplementationsEmpty", defaultMessage: "Interface property 'implementations' at index {index} must not be an empty array" }, options); },
    commands_test_error_interfacesItemImplementationsItemNotString: function (options) { return intl.formatMessage({ id: "commands_test_error_interfacesItemImplementationsItemNotString", defaultMessage: "Implementation at index ({index}, {implementationIndex}) must be a valid wrap:// URI string" }, options); },
    commands_test_error_envsExportNotArray: function () { return intl.formatMessage({ id: "commands_test_error_envsExportNotArray", defaultMessage: "Exported envs must be an array" }); },
    commands_test_error_envsItemNotObject: function (options) { return intl.formatMessage({ id: "commands_test_error_envsItemNotObject", defaultMessage: "Env at index {index} must be an object with properties 'uri'" }, options); },
    commands_test_error_envsItemUriNotString: function (options) { return intl.formatMessage({ id: "commands_test_error_envsItemUriNotString", defaultMessage: "Env property 'uri' at index {index} must be a valid wrap:// URI string" }, options); },
    commands_test_error_envsItemModuleNotObject: function (options) { return intl.formatMessage({ id: "commands_test_error_envsItemModuleNotObject", defaultMessage: "Env property 'env' at index {index} must be an object" }, options); },
    commands_test_description: function () { return intl.formatMessage({ id: "commands_test_description", defaultMessage: "Execute Tests" }); },
    commands_test_error_missingScript: function (options) { return intl.formatMessage({ id: "commands_test_error_missingScript", defaultMessage: "Required argument {script} is missing" }, options); },
    commands_test_error_noApi: function () { return intl.formatMessage({ id: "commands_test_error_noApi", defaultMessage: "API needs to be initialized" }); },
    commands_test_error_readFail: function (options) { return intl.formatMessage({ id: "commands_test_error_readFail", defaultMessage: "Failed to read query {query}" }, options); },
    commands_test_error_unsupportedOutputFileExt: function (options) { return intl.formatMessage({ id: "commands_test_error_unsupportedOutputFileExt", defaultMessage: "Unsupported outputFile extention: {outputFileExt}" }, options); },
    commands_test_error_cueDoesNotExist: function () { return intl.formatMessage({ id: "commands_test_error_cueDoesNotExist", defaultMessage: "Require cue to run validator, checkout https://cuelang.org/ for more information" }); },
    commands_test_error_noWorkflowScriptFound: function (options) { return intl.formatMessage({ id: "commands_test_error_noWorkflowScriptFound", defaultMessage: "Workflow script not found at path: {path}" }, options); },
    ...
    commands_docs_description: function () { return intl.formatMessage({ id: "commands_docs_description", defaultMessage: "Documentation commands" }); },
    commands_docs_init_description: function () { return intl.formatMessage({ id: "commands_docs_init_description", defaultMessage: "Initialize wrap docs" }); },
    commands_docs_init_m_path: function () { return intl.formatMessage({ id: "commands_docs_init_m_path", defaultMessage: "path" }); },
    commands_docs_options_m: function (options) { return intl.formatMessage({ id: "commands_docs_options_m", defaultMessage: "Path to the Polywrap manifest file (default: {default})" }, options); },
    commands_docs_init_error_manifest_exists: function (options) { return intl.formatMessage({ id: "commands_docs_init_error_manifest_exists", defaultMessage: "The {manifestFile} manifest already exists." }, options); },
    commands_docs_init_warn_update_manifest: function (options) { return intl.formatMessage({ id: "commands_docs_init_warn_update_manifest", defaultMessage: "Set the 'extensions.docs' property to {docsManifestFile} within your project's root manifest at {manifestFile}" }, options); },
    commands_docs_init_msg_manifest_created: function (options) { return intl.formatMessage({ id: "commands_docs_init_msg_manifest_created", defaultMessage: "Written docs manifest to {manifestFile}" }, options); },
    ...
    lib_compiler_cannotBuildModule: function (options) { return intl.formatMessage({ id: "lib_compiler_cannotBuildModule", defaultMessage: "Cannot build the module for a project of type {project}" }, options); },
    lib_compiler_missingBuildStrategy: function () { return intl.formatMessage({ id: "lib_compiler_missingBuildStrategy", defaultMessage: "The compiler is missing a build strategy" }); },
    lib_compiler_copyResourcesFolderText: function (options) { return intl.formatMessage({ id: "lib_compiler_copyResourcesFolderText", defaultMessage: "Copying resources folder: {folder}" }, options); },
    lib_compiler_copyResourcesFolderError: function (options) { return intl.formatMessage({ id: "lib_compiler_copyResourcesFolderError", defaultMessage: "Failed to copy resources folder: {folder}" }, options); },
    lib_compiler_copyResourcesFolderWarning: function (options) { return intl.formatMessage({ id: "lib_compiler_copyResourcesFolderWarning", defaultMessage: "Warnings copying resources folder: {folder}" }, options); },
    ...
    lib_helpers_gomod_unableToLoad: function (options) { return intl.formatMessage({ id: "lib_helpers_gomod_unableToLoad", defaultMessage: "Unable to load go.mod: {path}" }, options); },
    lib_helpers_gomod_invalid: function (options) { return intl.formatMessage({ id: "lib_helpers_gomod_invalid", defaultMessage: "Invalid format of go.mod: {path}" }, options); },
    ...
    lib_helpers_wrap_unsupportedType: function (options) { return intl.formatMessage({ id: "lib_helpers_wrap_unsupportedType", defaultMessage: "Unsupported WRAP type {type}" }, options); },
    ...
    lib_wasm_golang_invalidModule: function (options) { return intl.formatMessage({ id: "lib_wasm_golang_invalidModule", defaultMessage: "Module paths must point to go.mod file. Found: {path}" }, options); },
