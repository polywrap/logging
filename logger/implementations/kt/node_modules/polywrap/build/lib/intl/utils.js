...
function getLocaleData(locale) {
    var supportedLangs = fs
        .readdirSync("".concat(__dirname, "/../../../lang/"))
    ...
    var messages;
    try {
        messages = JSON.parse((0, fs_1.readFileSync)("".concat(__dirname, "/../../../lang/").concat(lang, ".json"), "utf-8"));
    }
    catch (e) {
        console.log("Language data for locale ".concat(locale, " is incomplete or malformed. Using default language instead."));
        messages = JSON.parse((0, fs_1.readFileSync)("".concat(__dirname, "/../../../lang/en.json"), "utf-8"));
    }
    return {
        lang: lang,
        messages: messages,
