...
var AppProject = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, (0, manifests_1.loadAppManifest)(this.getManifestPath(), this.logger)];
                    case 1:
    ...
    AppProject.prototype.getGenerationDirectory = function (generationSubPath) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._getGenerationDirectory(generationSubPath)];
            });
        });
    };
    AppProject.prototype.generateSchemaBindings = function (abi, generationSubPath, bindgenUri) {
        return __awaiter(this, void 0, void 0, function () {
            var bindLanguage, _a, options;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = manifests_1.appManifestLanguageToBindLanguage;
                    ...
                    case 2:
                        _b.wrapInfo = (_c.name = _d.sent(),
                            _c.type = (0, schema_bind_1.bindLanguageToWrapInfoType)(bindLanguage),
                            _c.abi = abi,
                            _c);
                        return [4 /*yield*/, this.getGenerationDirectory(generationSubPath)];
                    case 3:
                        options = (_b.outputDirAbs = _d.sent(),
                            _b);
    ...
    AppProject.prototype._getGenerationDirectory = function (useDefinedPath, defaultDir) {
