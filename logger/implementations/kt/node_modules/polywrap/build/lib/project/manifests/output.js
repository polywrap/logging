            ...
            switch (_a.label) {
                case 0:
                    run = function () {
                        ...
                        (0, os_js_1.writeFileSync)(manifestPath, str, "utf-8");
                    };
                    manifestPath = (0, __1.displayPath)(manifestPath);
                    return [4 /*yield*/, (0, __1.logActivity)(logger, __1.intlMsg.lib_helpers_manifest_outputText({
                            path: (0, os_js_1.normalizePath)(manifestPath),
