...
var Infra = /** @class */ (function () {
    ...
    Infra.prototype.up = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, __1.ensureDockerDaemonRunning)(this._config.logger)];
                    case 1:
                        _a.sent();
    ...
    Infra.prototype.config = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modulesWithPaths, configOptions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._fetchModules()];
                    case 1:
                        modulesWithPaths = _a.sent();
                        configOptions = __assign(__assign({}, this._defaultDockerOptions), { config: modulesWithPaths.map(function (m) { return m.path; }) });
                        return [4 /*yield*/, this._dockerCompose.commands.config(configOptions)];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        envVars = modulesWithComposePaths.reduce(function (acc, current) {
                            ...
                            return __spreadArray(__spreadArray([], __read(acc), false), __read(matches.map(function (match) {
                                if (match.startsWith("$")) {
                                    if (match.startsWith("${")) {
    ...
    Infra.prototype.getFilteredModules = function () {
        ...
        var defaultInfraModules = (0, fs_1.readdirSync)(defaultInfraModulesPath).map(function (moduleName) { return ({
            name: moduleName,
        ...
        var manifestAndDefaultModules = defaultInfraModules.reduce(function (prev, current) {
            ...
            if (!modulesInManifestNames.includes(current.name)) {
                return __spreadArray(__spreadArray([], __read(prev), false), [current], false);
            }
            return prev;
        }, manifestModules);
    ...
    Infra.prototype._fetchRemoteModules = function (modules, installationDir) {
        var _a, e_1, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var classifiedModules, modulesWithComposePaths, _loop_1, this_1, _d, _e, _f, e_1_1;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function () {
                            var _h, registry, modules_1, dependencyFetcher, mappedInfraModules, modulesWithPaths;
                                    ...
                                    case 2:
                                        ...
                                        modulesWithPaths = modules_1.map(function (m) {
                                            ...
                                            var packagePath = m.dockerComposePath
                                                ...
                                                : _this._tryResolveComposeFile(packageDir, _this._defaultModuleComposePaths);
                                            return { moduleName: m.name, path: packagePath };
                                        });
                                        modulesWithComposePaths.push.apply(modulesWithComposePaths, __spreadArray([], __read(modulesWithPaths), false));
                                        return [3 /*break*/, 4];
                                    case 3:
                                        _d = true;
                                        return [7 /*endfinally*/];
                        ...
                        this_1 = this;
                        _d = true, _e = __asyncValues(Object.entries(classifiedModules));
                        _g.label = 2;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        modulesWithComposePaths = __spreadArray(__spreadArray([], __read(remoteModulesWithComposePaths), false), __read(localModulesWithComposePaths), false);
                        modulesWithComposePaths.forEach(function (m) {
                            // Adjust package's docker-compose's build option if it exists
                            var composeFileWithCorrectPaths = (0, __1.correctBuildContextPathsFromCompose)(m.path);
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    for (modules_2 = __values(modules), modules_2_1 = modules_2.next(); !modules_2_1.done; modules_2_1 = modules_2.next()) {
                        ...
                        isFile = (0, fs_1.lstatSync)(module_1.path).isFile();
                        modulePath = path_1.default.join(basePath, isFile ? module_1.path : module_1.name);
                        (0, fs_extra_1.copySync)(module_1.path, modulePath);
                        composePath = this._tryResolveComposeFile(modulePath, this._defaultModuleComposePaths);
    ...
    Infra.prototype._fetchPathForDefaultModule = function (module) {
        var defaultModules = (0, fs_1.readdirSync)(this._config.defaultInfraModulesPath);
        var defaultModulePath = defaultModules.find(function (defaultModules) { return defaultModules === module; });
        if (!defaultModulePath) {
            throw new Error("Module ".concat(module, " not found as default\nDefault Modules available: ").concat(defaultModules
                .map(function (m) { return "\n- ".concat(m); })
                .join("")));
        }
        return path_1.default.join(this._config.defaultInfraModulesPath, defaultModulePath);
    };
    Infra.prototype._tryResolveComposeFile = function (moduleDir, pathsToTry, triedPaths) {
        if (triedPaths === void 0) { triedPaths = []; }
        if (!pathsToTry.length) {
            throw new Error("Could not resolve docker compose file. Tried paths: ".concat(triedPaths));
        }
        var pathToTry = (0, fs_1.lstatSync)(moduleDir).isFile()
            ? moduleDir
            : path_1.default.join(moduleDir, pathsToTry[0]);
        if (fs_1.default.existsSync(pathToTry)) {
            return pathToTry;
        }
        return this._tryResolveComposeFile(moduleDir, pathsToTry.slice(1), __spreadArray(__spreadArray([], __read(triedPaths), false), [
            pathToTry,
        ], false));
    };
    Infra.cacheLayout = {
