...
var ScriptCodegenerator = /** @class */ (function (_super) {
    ...
    ScriptCodegenerator.prototype.runCodegen = function (bindLanguage) {
        return __awaiter(this, void 0, void 0, function () {
            var generator, _a, generateBinding, outputDirAbs, binding, _b;
            var _c, _d;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (!(0, system_1.isTypescriptFile)(this._script)) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, system_1.importTypescriptModule)(this._script)];
                    case 1:
                        _a = _e.sent();
                        return [3 /*break*/, 4];
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this._config.project.getGenerationDirectory(this._config.codegenDirAbs)];
                    case 5:
                        outputDirAbs = _e.sent();
                        _b = generateBinding;
                        _c = {
                    ...
                    case 6:
                        _d.name = _e.sent(),
                            _d.type = (0, schema_bind_1.bindLanguageToWrapInfoType)(bindLanguage);
                        return [4 /*yield*/, this._config.schemaComposer.getComposedAbis()];
                    case 7: return [4 /*yield*/, _b.apply(void 0, [(_c.wrapInfo = (_d.abi = _e.sent(),
                                _d),
                                _c.config = this._mustacheView,
                                _c.outputDirAbs = outputDirAbs,
                                _c)])];
                    case 8:
                        binding = _e.sent();
                        (0, system_1.resetDir)(outputDirAbs);
                        return [2 /*return*/, (0, os_js_1.writeDirectorySync)(outputDirAbs, binding.output, function (templatePath) { return _this._generateTemplate(templatePath, {}); })];
                }
            });
        });
    };
    ScriptCodegenerator.prototype._generateTemplate = function (templatePath, config) {
        ...
        var template = (0, fs_extra_1.readFileSync)(templatePath);
        ...
        content = "// ".concat(intl_1.intlMsg.lib_codeGenerator_templateNoModify(), "\n\n").concat(content, "\n");
        return content;
    };
