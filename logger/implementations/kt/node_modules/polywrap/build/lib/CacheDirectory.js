...
exports.CacheDirectory = exports.globalCacheRoot = void 0;
...
exports.globalCacheRoot = process.platform == "darwin"
...
var CacheDirectory = /** @class */ (function () {
    ...
    CacheDirectory.prototype.initCache = function () {
    ...
    CacheDirectory.prototype.writeCacheFile = function (subPath, data, options) {
        ...
        (0, os_js_1.writeFileSync)(filePath, data, options);
    };
    CacheDirectory.prototype.appendToCacheFile = function (subPath, data, options) {
        var filePath = this.getCachePath(subPath);
        var folderPath = path_1.default.dirname(filePath);
        // Create folders if they don't exist
        if (!fs_1.default.existsSync(folderPath)) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                (0, copyfiles_1.default)([sourceDir, dest], options, function (error) {
                                    if (error) {
                                        reject(error);
                                    }
                                    else {
    ...
    CacheDirectory.prototype.copyFromCache = function (sourceSubDir, destDir) {
        return __awaiter(this, void 0, void 0, function () {
            var source;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        source = this.getCachePath(sourceSubDir);
                        if (!fs_1.default.existsSync(destDir)) {
                            fs_1.default.mkdirSync(destDir, { recursive: true });
                        }
                        return [4 /*yield*/, fs_extra_1.default.copy(source, destDir, {
                                overwrite: true,
                            })];
                    case 1:
                        _a.sent();
