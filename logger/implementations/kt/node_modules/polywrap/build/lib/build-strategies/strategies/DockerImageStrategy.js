...
var DockerImageBuildStrategy = /** @class */ (function (_super) {
    ...
    function DockerImageBuildStrategy(config) {
            ...
            return __generator(this, function (_m) {
                switch (_m.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, system_1.ensureDockerDaemonRunning)(this.project.logger)];
                    case 3:
                        _m.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 2:
                                        // Make sure the interactive terminal name is available
                                        _a;
                                        containerLsOutput = (0, system_1.runCommandSync)("docker", ["container", "ls", "-a"], this.project.logger).stdout;
                                        if (!(containerLsOutput &&
                                            containerLsOutput.indexOf("root-".concat(imageName)) > -1)) return [3 /*break*/, 4];
                                        return [4 /*yield*/, (0, system_1.runCommand)("docker", ["rm", "-f", "root-".concat(imageName)], this.project.logger)];
                                    case 3:
                                        _b.sent();
                                        _b.label = 4;
                                    case 4: 
                                    // Create a new interactive terminal
                                    return [4 /*yield*/, (0, system_1.runCommand)("docker", ["create", "-ti", "--name", "root-".concat(imageName), imageName], this.project.logger)];
                                    case 5:
                                        // Create a new interactive terminal
                                        _b.sent();
                                        projectLsOutput = (0, system_1.runCommandSync)("docker", ["run", "--rm", imageName, "/bin/bash", "-c", '"ls /project"'], this.project.logger).stdout;
                                        ...
                                        buildLsOutput = (0, system_1.runCommandSync)("docker", ["run", "--rm", imageName, "/bin/bash", "-c", '"ls /project/build"'], this.project.logger).stdout;
                                        ...
                                        return [4 /*yield*/, (0, system_1.runCommand)("docker", ["cp", "root-".concat(imageName, ":/project/build/").concat(buildArtifact), outputDir], this.project.logger)];
                                    case 6:
                                        _b.sent();
                                        return [4 /*yield*/, (0, system_1.runCommand)("docker", ["rm", "-f", "root-".concat(imageName)], this.project.logger)];
                                    case 7:
                                        ...
                                        return [4 /*yield*/, (0, system_1.runCommand)("docker", ["buildx", "rm", imageName], this.project.logger)];
                                    case 8:
                                        _b.sent();
                                        _b.label = 9;
                                    case 9:
                                        if (!removeImage) return [3 /*break*/, 11];
                                        return [4 /*yield*/, (0, system_1.runCommand)("docker", ["rmi", imageName], this.project.logger)];
                                    case 10:
                                        _b.sent();
                                        _b.label = 11;
                        ...
                        args = {
                            path: (0, system_1.displayPath)(outputDir),
                            image: imageName,
                        };
                        return [4 /*yield*/, (0, logging_1.logActivity)(this.project.logger, intl_1.intlMsg.lib_helpers_docker_copyText(args), intl_1.intlMsg.lib_helpers_docker_copyError(args), intl_1.intlMsg.lib_helpers_docker_copyWarning(args), function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                                ...
                                switch (_b.label) {
                                    ...
                                    case 2:
                                        ...
                                        cacheFrom = cacheDir && fs_1.default.existsSync(path_1.default.join(cacheDir, "index.json"))
                                            ? "--cache-from type=local,src=".concat(cacheDir)
                                            : "";
                                        cacheTo = cacheDir
                                            ? "--cache-to type=local,dest=".concat(cacheDir)
                                            : "";
                                        buildxUseFailed = void 0;
                                        try {
                                            stderr = (0, system_1.runCommandSync)("docker", ["buildx", "use", imageName], this.project.logger).stderr;
                                        ...
                                        return [4 /*yield*/, (0, system_1.runCommand)("docker", ["buildx", "create", "--use", "--name", imageName], this.project.logger)];
                                    case 3:
                                        _b.sent();
                                        _b.label = 4;
                                    case 4: return [4 /*yield*/, (0, system_1.runCommand)("docker", [
                                            "buildx",
                                            "build",
                                            "-f",
                                            dockerfile,
                                            ...
                                            cacheTo,
                                            "--output=type=docker",
                                        ], this.project.logger, undefined, undefined, true)];
                                    case 5:
                                        _b.sent();
                                        return [3 /*break*/, 8];
                                    case 6: return [4 /*yield*/, (0, system_1.runCommand)("docker", ["build", "-f", dockerfile, "-t", imageName, rootDir], this.project.logger, (0, os_js_1.isWin)()
                                            ? undefined
                                            : {
                                    ...
                                    case 7:
                                        ...
                                        _b.label = 8;
                                    case 8:
                                        stdout = (0, system_1.runCommandSync)("docker", ["image", "inspect", imageName, "-f", "{{.ID}}"], this.project.logger).stdout;
                        ...
                        args = {
                            image: imageName,
                            dockerfile: (0, system_1.displayPath)(dockerfile),
                            context: (0, system_1.displayPath)(rootDir),
                        };
                        return [4 /*yield*/, (0, logging_1.logActivity)(this.project.logger, intl_1.intlMsg.lib_helpers_docker_buildText(args), intl_1.intlMsg.lib_helpers_docker_buildError(args), intl_1.intlMsg.lib_helpers_docker_buildWarning(args), function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, run()];
                                        case 1: return [2 /*return*/, _a.sent()];
    ...
    DockerImageBuildStrategy.prototype._isDockerBuildxInstalled = function () {
        return __awaiter(this, void 0, void 0, function () {
            var version;
            return __generator(this, function (_a) {
                version = (0, system_1.runCommandSync)("docker", ["buildx", "version"], this.project.logger).stdout;
    ...
    DockerImageBuildStrategy.prototype._generateDockerfile = function (templatePath, config) {
        ...
        (0, os_js_1.writeFileSync)(outputFilePath, dockerfile, "utf-8");
