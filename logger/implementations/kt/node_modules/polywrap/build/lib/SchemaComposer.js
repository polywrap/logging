...
var SchemaComposer = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!schemaFile) {
                            throw Error("Schema cannot be loaded at path: ".concat(schemaNamedPath));
                        }
                        options = {
                            schema: schemaFile,
                            abiResolver: function (importFrom, schemaFile) {
                                return _this._abiResolver(schemaFile, importFrom, import_abis);
                            },
                        };
                        _a = this;
                        return [4 /*yield*/, (0, schema_compose_1.composeSchema)(options)];
                    case 3:
                        _a._abi = _b.sent();
    ...
    SchemaComposer.prototype._abiResolver = function (schemaFile, importFrom, import_abis) {
        if (client_js_1.Uri.isValidUri(importFrom)) {
            return this._resolveUri(importFrom, import_abis);
        }
        else {
            return Promise.resolve(this._resolvePath(importFrom, path_1.default.dirname(schemaFile.absolutePath)));
        }
    };
    SchemaComposer.prototype._resolvePath = function (importFrom, sourceDir) {
        var schemaPath = path_1.default.isAbsolute(importFrom)
            ? importFrom
            : path_1.default.join(sourceDir, importFrom);
    ...
    SchemaComposer.prototype._resolveUri = function (uri, import_abis) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, schema_compose_1.composeSchema)({
                                schema: {
                                    schema: schema,
                                    absolutePath: path,
                                },
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, wrap_manifest_types_js_1.deserializeWrapManifest)(manifest)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, wrap_manifest_types_js_1.validateWrapManifest)({
                                version: "0.1",
                                type: "interface",
                                name: "temp",
                                abi: result,
