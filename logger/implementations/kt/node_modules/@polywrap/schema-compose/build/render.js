...
function renderSchema(abi, header) {
    ...
    abi = (0, schema_parse_1.transformAbi)(abi, schema_parse_1.addFirstLast);
    abi = (0, schema_parse_1.transformAbi)(abi, schema_parse_1.toGraphQLType);
    abi = (0, schema_parse_1.transformAbi)(abi, (0, schema_parse_1.moduleCapabilities)());
    abi = (0, schema_parse_1.transformAbi)(abi, schema_parse_1.addAnnotations);
    abi = (0, schema_parse_1.transformAbi)(abi, {
        enter: {
