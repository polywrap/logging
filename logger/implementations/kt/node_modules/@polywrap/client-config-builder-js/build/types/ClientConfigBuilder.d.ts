...
export interface ClientConfigBuilder {
     ...
     * @returns ClientConfigBuilder (mutated self)
     */
    addEnvs(uriEnvs: Record<string, Record<string, unknown>>): ClientConfigBuilder;
    /**
     * Remove an Env
     *
     ...
     * @returns ClientConfigBuilder (mutated self)
     */
    addInterfaceImplementations(interfaceUri: string, implementationUris: Array<string>): ClientConfigBuilder;
    /**
