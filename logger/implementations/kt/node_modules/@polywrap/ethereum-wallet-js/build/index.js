...
exports.plugin = exports.ethereumWalletPlugin = exports.EthereumWalletPlugin = void 0;
...
var EthereumWalletPlugin = /** @class */ (function (_super) {
    __extends(EthereumWalletPlugin, _super);
    function EthereumWalletPlugin(config) {
        var _this = _super.call(this, config) || this;
        _this._connections = config.connections;
        return _this;
    }
    EthereumWalletPlugin.prototype.request = function (args, _client, env) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var connection, paramsStr, provider, network, signer, parameters, request, res, signer, parameters, signature, _b, _, data, payload, params_1, req, params, req, err_1, paramsIsArray, messageContains0x2, req;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this._getConnection(args.connection, env)];
                    case 1:
                        connection = _c.sent();
                    ...
                    case 6:
                        ...
                        if (!(connection.getSignerType() == Connection_1.SignerType.CUSTOM_SIGNER)) return [3 /*break*/, 10];
                        return [4 /*yield*/, connection.getSigner()];
                    case 7:
                        signer = _c.sent();
                    ...
                    case 10:
                        if (!(provider.connection.url == "metamask")) return [3 /*break*/, 12];
                        params_1 = JSON.parse(paramsStr);
                        return [4 /*yield*/, provider.send(args.method, [
                                params_1[0],
                                JSON.stringify(params_1[1]),
                            ])];
                    case 11:
                        req = _c.sent();
    ...
    EthereumWalletPlugin.prototype.waitForTransaction = function (args, _client, env) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    EthereumWalletPlugin.prototype.signerAddress = function (args, _client, env) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this._getConnection(args.connection, env)];
                    case 1:
                        connection = _a.sent();
    ...
    EthereumWalletPlugin.prototype.signMessage = function (args, _client, env) {
        return __awaiter(this, void 0, void 0, function () {
            var connection;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EthereumWalletPlugin.prototype.signTransaction = function (args, _client, env) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EthereumWalletPlugin.prototype._getConnection = function (connection, env) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._connections.getConnection(connection !== null && connection !== void 0 ? connection : env === null || env === void 0 ? void 0 : env.connection)];
            });
        });
    };
    EthereumWalletPlugin.prototype._parseTransaction = function (rlp) {
    ...
    return EthereumWalletPlugin;
}(wrap_1.Module));
exports.EthereumWalletPlugin = EthereumWalletPlugin;
var ethereumWalletPlugin = function (config) {
    return new plugin_js_1.PluginPackage(new EthereumWalletPlugin(config), wrap_1.manifest);
};
exports.ethereumWalletPlugin = ethereumWalletPlugin;
exports.plugin = exports.ethereumWalletPlugin;
