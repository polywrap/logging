 ...
 * */
var PackageResolver = /** @class */ (function (_super) {
    __extends(PackageResolver, _super); /* $ */
     ...
     * */
    function PackageResolver(_uri, wrapPackage) {
        var _this = _super.call(this) || this;
        _this._uri = _uri;
        _this.wrapPackage = wrapPackage;
        ...
        _this.getStepDescription = function () {
            return "Package (".concat(_this._uri.uri, ")");
        };
        return _this;
    }
     ...
     */
    PackageResolver.prototype._tryResolveUri = function (uri) {
