...
exports.WrapperResolver = void 0;
 ...
 * */
var WrapperResolver = /** @class */ (function (_super) {
    __extends(WrapperResolver, _super); /* $ */
     ...
     * */
    function WrapperResolver(_uri, _wrapper) {
        ...
        _this.getStepDescription = function () {
            return "Wrapper (".concat(_this._uri.uri, ")");
        };
        return _this;
    }
     ...
     */
    WrapperResolver.prototype._tryResolveUri = function (uri) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (uri.uri !== this._uri.uri) {
                    return [2 /*return*/, core_js_1.UriResolutionResult.ok(uri)];
                }
                return [2 /*return*/, core_js_1.UriResolutionResult.ok(uri, this._wrapper)];
            });
        });
    };
    return WrapperResolver;
}(helpers_1.ResolverWithHistory /* $ */));
exports.WrapperResolver = WrapperResolver;
