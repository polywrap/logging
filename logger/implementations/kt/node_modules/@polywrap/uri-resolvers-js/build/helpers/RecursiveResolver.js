...
var RecursiveResolver = /** @class */ (function () {
     ...
     * */
    function RecursiveResolver(_resolver) {
     ...
     * */
    RecursiveResolver.from = function (resolver) {
        return new RecursiveResolver(UriResolver_1.UriResolver.from(resolver));
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._tryResolveAgainIfRedirect(resolverResult, uri, client, resolutionContext)];
                    case 2:
                        result = _a.sent();
    ...
    RecursiveResolver.prototype._tryResolveAgainIfRedirect = function (result, uri, client, resolutionContext) {
        return __awaiter(this, void 0, void 0, function () {
            var resultUri;
            return __generator(this, function (_a) {
                switch (_a.label) {
