...
function transformType(type, transform) {
    ...
    if (GenericDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Generic)) {
        result = Object.assign(result, GenericDefinition(result));
    }
    if (ObjectDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Object)) {
        result = Object.assign(result, ObjectDefinition(result));
    }
    if (ObjectRef && (0, abi_1.isKind)(result, abi_1.DefinitionKind.ObjectRef)) {
        result = Object.assign(result, ObjectRef(result));
    }
    if (AnyDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Any)) {
        result = Object.assign(result, AnyDefinition(result));
    }
    if (ScalarDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Scalar)) {
        result = Object.assign(result, ScalarDefinition(result));
    }
    if (EnumDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Enum)) {
        result = Object.assign(result, EnumDefinition(result));
    }
    if (EnumRef && (0, abi_1.isKind)(result, abi_1.DefinitionKind.EnumRef)) {
        result = Object.assign(result, EnumRef(result));
    }
    if (ArrayDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Array)) {
        result = Object.assign(result, ArrayDefinition(result));
    }
    if (PropertyDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Property)) {
        result = Object.assign(result, PropertyDefinition(result));
    }
    if (MethodDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Method)) {
        result = Object.assign(result, MethodDefinition(result));
    }
    if (ModuleDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Module)) {
        result = Object.assign(result, ModuleDefinition(result));
    }
    if (InterfaceDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Interface)) {
        result = Object.assign(result, InterfaceDefinition(result));
    }
    if (ImportedModuleDefinition &&
        (0, abi_1.isKind)(result, abi_1.DefinitionKind.ImportedModule)) {
        result = Object.assign(result, ImportedModuleDefinition(result));
    }
    if (ImportedEnumDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.ImportedEnum)) {
        result = Object.assign(result, ImportedEnumDefinition(result));
    }
    if (ImportedObjectDefinition &&
        (0, abi_1.isKind)(result, abi_1.DefinitionKind.ImportedObject)) {
        result = Object.assign(result, ImportedObjectDefinition(result));
    }
    if (InterfaceImplementedDefinition &&
        (0, abi_1.isKind)(result, abi_1.DefinitionKind.InterfaceImplemented)) {
        result = Object.assign(result, InterfaceImplementedDefinition(result));
    }
    if (EnvDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Env)) {
        result = Object.assign(result, EnvDefinition(result));
    }
    if (ImportedEnvDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.ImportedEnv)) {
        result = Object.assign(result, ImportedEnvDefinition(result));
    }
    if (MapDefinition && (0, abi_1.isKind)(result, abi_1.DefinitionKind.Map)) {
