...
function parseSchema(schema, options) {
    ...
    var astNode = (0, graphql_1.parse)(schema);
    ...
    return {
        ...
        interfaceTypes: ((_d = info.interfaceTypes) === null || _d === void 0 ? void 0 : _d.length)
            ? info.interfaceTypes
            : undefined,
        importedObjectTypes: ((_e = info.importedObjectTypes) === null || _e === void 0 ? void 0 : _e.length)
            ? info.importedObjectTypes
            : undefined,
        importedModuleTypes: ((_f = info.importedModuleTypes) === null || _f === void 0 ? void 0 : _f.length)
            ? info.importedModuleTypes
            : undefined,
        importedEnumTypes: ((_g = info.importedEnumTypes) === null || _g === void 0 ? void 0 : _g.length)
            ? info.importedEnumTypes
            : undefined,
        importedEnvTypes: ((_h = info.importedEnvTypes) === null || _h === void 0 ? void 0 : _h.length)
...
var validate = function (astNode, validators) {
    ...
    (0, graphql_1.visit)(astNode, (0, graphql_1.visitInParallel)(allVisitors));
    try {
