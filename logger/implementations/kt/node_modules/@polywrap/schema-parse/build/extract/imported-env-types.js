...
var visitorEnter = function (importedEnvTypes, state) { return ({
    ObjectTypeDefinition: function (node) {
        var _a, _b;
        var imported = (0, imported_types_utils_1.extractImportedDefinition)(node, "env");
        if (!imported) {
            return;
        }
        ...
        var importedType = (0, __1.createImportedEnvDefinition)({
            uri: imported.uri,
    ...
    NamedType: function (node) {
        (0, object_types_utils_1.extractNamedType)(node, state);
    },
    ListType: function (_node) {
        (0, object_types_utils_1.extractListType)(state);
    },
    FieldDefinition: function (node) {
        (0, object_types_utils_1.extractFieldDefinition)(node, state);
    },
}); };
