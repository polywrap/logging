...
function deserializePolywrapWorkflow(manifest, options) {
    ...
    if (!anyPolywrapWorkflow) {
        throw Error("Unable to parse PolywrapWorkflow: ".concat(manifest));
    }
    if (!options || !options.noValidate) {
        (0, _1.validatePolywrapWorkflow)(anyPolywrapWorkflow, options === null || options === void 0 ? void 0 : options.extSchema);
    }
    ...
    if (versionCompare === -1) {
        ...
        (_a = options === null || options === void 0 ? void 0 : options.logger) === null || _a === void 0 ? void 0 : _a.warn("PolywrapWorkflow is using an older version of the manifest format (".concat(anyPolywrapWorkflow.format, "). Please update your manifest to the latest version (").concat(_1.latestPolywrapWorkflowFormat, ") by using the \"polywrap manifest migrate <type>\" command."));
        // Upgrade
        return (0, _1.migratePolywrapWorkflow)(anyPolywrapWorkflow, _1.latestPolywrapWorkflowFormat, options === null || options === void 0 ? void 0 : options.logger);
    }
    else if (versionCompare === 1) {
        // Downgrade
        throw Error("Cannot downgrade Polywrap version ".concat(anyPolywrapWorkflow.format, ", please upgrade your PolywrapClient package."));
    }
    else {
        // Latest
