...
function validateInfraManifest(manifest, extSchema) {
    ...
    if (!schema) {
        throw Error("Unrecognized InfraManifest schema format \"".concat(manifest.format, "\"\nmanifest: ").concat(JSON.stringify(manifest, null, 2)));
    }
    var throwIfErrors = function (result) {
        if (result.errors.length) {
            throw new Error(__spreadArray([
                "Validation errors encountered while sanitizing InfraManifest format ".concat(manifest.format)
