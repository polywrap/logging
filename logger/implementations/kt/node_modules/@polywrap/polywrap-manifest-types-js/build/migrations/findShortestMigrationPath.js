...
function findShortestMigrationPath(nodes, from, to) {
    ...
    var visited = __spreadArray([], __read(possibleStarts), false);
    ...
    var _loop_1 = function () {
        ...
        try {
            for (var neighbours_1 = (e_1 = void 0, __values(neighbours)), neighbours_1_1 = neighbours_1.next(); !neighbours_1_1.done; neighbours_1_1 = neighbours_1.next()) {
                ...
                if (neighbour.to === to) {
                    return { value: __spreadArray(__spreadArray([], __read(path), false), [neighbour], false) };
                }
                queue.push([neighbour, __spreadArray(__spreadArray([], __read(path), false), [neighbour], false)]);
            }
        }
